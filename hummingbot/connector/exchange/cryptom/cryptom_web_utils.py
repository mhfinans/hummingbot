...
import hummingbot.connector.exchange.cryptom.cryptom_constants as CONSTANTS
...
def public_rest_url(path_url: str, domain: str = CONSTANTS.DEFAULT_DOMAIN) -> str:
    ...
    """
    return urljoin(CONSTANTS.CRYPTOM_BASE_URL, path_url)
...
async def get_current_server_time(
    ...
    response = await rest_assistant.execute_request(
        url=public_rest_url(path_url=CONSTANTS.CRYPTOM_SERVER_TIME_PATH),
        method=RESTMethod.GET,
        throttler_limit_id=CONSTANTS.CRYPTOM_SERVER_TIME_PATH,
    )
